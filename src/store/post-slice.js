...
export const PostSlice = createSlice({
  ...
  extraReducers: {
    ...
    [removeLikeFromAPost.pending]: state => {
      state.postStatus = 'pending';
    },
    [removeLikeFromAPost.rejected]: state => {
      state.postStatus = 'error';
    },
    ...
    [deleteAPost.pending]: state => {
      state.postStatus = 'pending';
    },
    [deleteAPost.rejected]: state => {
      state.postStatus = 'error';
    },
    ...
    [getAPost.pending]: state => {
      state.postStatus = 'pending';
    },
    [getAPost.rejected]: state => {
      state.postStatus = 'error';
    },
